...
class AuthApiIntegrationTest
{
    ...
    void testRestEndpoint_withCorrectCredentials_whenUsing_DaoAuthenticationProvider()
    {
        ...
        try
        {
            ...
            AuthorizationToken authentication = webserviceClient.authenticate(null);	//most nem kell processId
            log.debug(authentication.getJwt());
        }
        catch (Exception e)			//nincs assert, nem kell ellenőrizni, mert ha rossz az auth, token, akkor exception lesz
        {

...
@Order(Ordered.HIGHEST_PRECEDENCE)	//ezt a bean-t hozza létre először
@ControllerAdvice
@Slf4j
public class ApplicationSpecificRestExceptionHandler extends RestResponseEntityExceptionHandler
{
     ...
     private static final org.slf4j.Logger log = org.slf4j.LoggerFactory.getLogger(ApplicationSpecificRestExceptionHandler.class);

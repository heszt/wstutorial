...
@RestController
public class AuthController extends AbstractInterfaceLogger implements AuthApi	//spvitamin AuthApi implementációja
{

    private final JwtTokenProvider tokenProvider;
    private final AuthorizationService authorizationService;

    //a username, pw-ből előállít egy jwt tokent
